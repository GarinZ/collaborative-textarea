...
ot.Client = (function (global) {
  ...
  function Client (revision) {
    ...
    /**
     * state是当前Client和Serve之间数据同步状态的标识位
     * TODO：为什么要区分这三种状态，需要有什么不同的处理么？
     * Synchronized 本地所有操作均被服务器接收
     * AwaitingConfirm 本地有一个操作已经发送给服务器，但尚未被接收
     * AwaitingWithBuffer 之前有1个操作仍未被接收，buffer中又堆积了新的操作
     */
